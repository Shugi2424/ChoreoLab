...
| Document | Purpose | Status |
|----------|---------|--------|
| [domains/DB.md](./domains/DB.md) | Body elements, risks, categories, DB rules | **Draft — needs your input** |
| [domains/DA.md](./domains/DA.md) | Masteries, bases, DA criteria, rotations, R criteria | **Draft — needs your input** |
| [domains/ARTISTRY.md](./domains/ARTISTRY.md) | Artistry components and requirements | **Draft — needs your input** |
| [domains/VALIDATION.md](./domains/VALIDATION.md) | CoP requirement rules per apparatus/age | **Draft — needs your input** |
